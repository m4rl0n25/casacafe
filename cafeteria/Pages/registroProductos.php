...
<head>
    ...
    <link rel="stylesheet" href="../../css/cafeteria_registro.css">
</head>
<body>
    <div class="sidebar">
    ...
    <div class="content">
        <h1><a class="back-link" href="verProductos.php">&lt;Volver</a>Registro de Productos</h1>
        <form class="formRegistro" enctype="multipart/form-data">
            <label for="nombre">Nombre del Producto:</label>
            <input type="text" id="nombre" name="nombre" required>
            <label for="precio">Precio del Producto:</label>
            <input type="text" id="precio" name="precio" required>
            <label for="precio">Presentacion del Producto:</label>
            <input type="text" id="presentacion" name="presentacion" required>
            <label for="imagen">Imagen del Producto:</label>    
            <input type="file" id="imagen" name="imagen" accept="image/*" required>
            <input class="submitREG" type="submit" value="Registrar Producto">
        </form>
    </div>
</body>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        form.addEventListener("submit", function(event) {
            ...
            xhr.open("POST", "registrarProductoService.php", true);
