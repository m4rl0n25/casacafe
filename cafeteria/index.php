...
<html>
<head>
    <title>Módulo de Cafetería</title>
    <link rel="stylesheet" href="../css/cafeteria_index.css">
</head>
<body>
    <div class="sidebar">
        ...
        <a href="Pages/verVentas.php">Ver Ventas</a>
        <a href="Pages/verProductos.php">Ver Productos</a>
        <a href="Pages/verIngresos.php">Ver Ingresos</a>
        <form action="index.php" method="POST">
            <input type="submit" value="Cerrar Sesión" formnovalidate>
        </form>
    </div>
    <div class="content">
        <h1><a class="back-link" href="../index.php">&lt;Volver</a>Módulo de Cafetería</h1>
        <p class="welcome">Hola, <?php echo $_SESSION['nombre_usuario']; ?>. ¡Bienvenido de nuevo!</p>
        <div class="options">
            <button><a href="Pages/verVentas.php">Ver Ventas</a></button>
            <button><a href="Pages/verProductos.php">Ver Productos</a></button>
            <button><a href="Pages/verIngresos.php">Ver Ingresos</a></button>
        </div>
    </div>
</body>
</html>
