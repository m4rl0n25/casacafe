...
<head>
    ...
    <link rel="stylesheet" href="../../css/hostal_registro.css">
</head>
<body>
<div class="sidebar">
        ...
        <form action="registrarHabitacion.php" method="POST">
            <input type="submit" value="Cerrar Sesión" formnovalidate>
        </form>
    </div>
    <div class="content">
        <h1><a class="back-link" href="habitaciones.php">&lt;Volver</a> Registro de Habitaciones</h1>
        <form class="formRegistro" action="registrarHabitacion.php" method="POST">
            ...
            <input type="text" name="precio_dia" id="precio_dia" required>

            <label for="precio_noche">Precio Noche:</label>
            <input type="text" name="precio_noche" id="precio_noche" required>

            <label for="capacidad">Numero personas:</label>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        form.addEventListener("submit", function(event) {
            ...
            var numero_habitacion = document.getElementById("numero_habitacion").value; 
            var tipo_habitacion = document.getElementById("tipo_habitacion").value;
            var precio_dia = document.getElementById("precio_dia").value;
            var precio_noche = document.getElementById("precio_noche").value;
            var capacidad = document.getElementById("capacidad").value;

            var formData = new FormData();
            formData.append("numero_habitacion", numero_habitacion);
            formData.append("tipo_habitacion", tipo_habitacion);
            formData.append("precio_dia", precio_dia);
            formData.append("precio_noche", precio_noche);
            formData.append("capacidad", capacidad);

            var xhr = new XMLHttpRequest();
            xhr.open("POST", "registroHabitacion.php", true);
