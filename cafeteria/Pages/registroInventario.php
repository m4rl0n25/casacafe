...
<body>
    ...
    <div class="content">
        <h1><a class="back-link" href="verProductos.php">&lt;Volver</a>Registro de Inventario</h1>
            ...
            <select id="idProducto" name="idProducto" required>
                <?php 
                    ...
                    foreach ($productos as $producto) {
                        echo "<option value='". $producto->getId(). "'> ". $producto->getNom(). " #". $producto->getId(). "</option>";
                    }
                ?>
            </select>
            <label for="cantidad">Cantidad:</label>
            <input type="number" id="cantidad" name="cantidad" required>
            <input class="submitREG" type="submit" value="Registrar Inventario">
        </form>
    </div>
</body>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        form.addEventListener("submit", function(event) {
            ...
            xhr.open("POST", "registrarInventarioService.php", true);
