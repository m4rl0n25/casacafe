...
<html>
<head>
    <title>Módulo de Hospedaje</title>
...
<body>
    <div class="sidebar">
        ...
        <a href="Pages/verCliente.php">Ver Clientes</a>
        <a href="Pages/habitaciones.php">Ver Habitaciones</a>
        <a href="Pages/verReservas.php">Ver Reservas</a>
        <a href="Pages/registroIngresos.php">Registro de Ingresos</a>
        <form action="index.php" method="POST">
            <input type="submit" value="Cerrar Sesión" formnovalidate>
        </form>
    </div>
    <div class="content">
        <h1><a class="back-link" href="../index.php">&lt;Volver</a>Módulo de Hospedaje</h1>
        <p class="welcome">Hola, <?php echo $_SESSION['nombre_usuario']; ?>. ¡Bienvenido de nuevo!</p>
        <div class="options">
            <button><a href="Pages/verCliente.php">Ver Clientes</a></button>
            <button><a href="Pages/habitaciones.php">Ver Habitaciones</a></button>
            <button><a href="Pages/verReservas.php">Ver Reservas</a></button><br><br>
            <button><a href="Pages/registroIngresos.php">Registro de Ingresos</a></button>
        </div>
    </div>
</body>
</html>
