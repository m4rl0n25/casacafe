...
<head>
    ...
    <title>Home</title>
    <link rel="stylesheet" href="../css/administracion_index.css">
</head>
<body>
    <div class="sidebar">
        ...
        <a href="Pages/verUsuarios.php">Ver Usuarios</a>
        <a href="Pages/editarRoles.php">Editar Roles</a>
        <a href="Pages/parametrosRoles.php">Editar parametros cargos</a>
        <form action="index.php" method="POST">
            <input type="submit" value="Cerrar Sesión" formnovalidate>
        </form>
    </div>
    <div class="content">
        <h1><a class="back-link" href="../index.php">&lt;Volver</a>Módulo de Administración</h1>
        <p class="welcome">Hola, <?php echo $_SESSION['nombre_usuario']; ?>. ¡Bienvenido de nuevo!</p>
        <div class="options">
            <button><a href="Pages/verUsuarios.php">Ver usuarios</a></button>
            <button><a href="Pages/parametrosRoles.php">Editar parámetros de cargos</a></button>
            <button><a href="Pages/editarRoles.php">Gestionar roles</a></button>
        </div>
    </div>
</body>
</html>
