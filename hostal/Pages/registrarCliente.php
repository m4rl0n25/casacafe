...
<html>
<head>
    <title>Modulo de Hospedaje</title>
...
<div class="sidebar">
    ...
    <div class="content">
        <h1><a class="back-link" href="verCliente.php">&lt;Volver</a> Registro de Cliente</h1>
        <form class="formRegistro" action="registrarCliente.php" method="POST">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        form.addEventListener("submit", function(event) {
            ...
            xhr.open("POST", "registrarClienteService.php", true);
