...
<body>
        ...
        <img class="image-logo"
         ...
         <?php 
            if($_SESSION['rol'] == "administrador"){
                echo '<a href="administracion/index.php">Módulo de Administración</a>';
            }
        ?>
        <a href="dashboard/index.php">Modulo de Dashboard</a>
        <a href="cafeteria/index.php">Modulo de cafeteria</a>
        <a href="hostal/index.php">Modulo de hospedaje</a>
    ...
    <div class="content">
        ...
        <div class="options">
            <?php 
                if($_SESSION['rol'] == "administrador"){
                    echo '<button><a href="administracion/index.php">Módulo de Administración</a></button>';
                }
            ?>
            <button><a href="dashboard/index.php">Módulo de Dashboard</a></button>
            <button><a href="cafeteria/index.php">Módulo de Cafetería</a></button>
            <button><a href="hostal/index.php">Módulo de Hospedaje</a></button>
        </div>
    </div>
</body>
</html>
