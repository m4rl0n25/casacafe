...
<body>
    <div class="sidebar">
        ...
        <form action="verHabitacionesReservadas.php" method="POST">
            <input type="submit" value="Cerrar Sesión" formnovalidate>
        </form>
    </div>
    <div class="content">
        <h1><a class="back-link" href="habitaciones.php">&lt;Volver</a> Habitaciones Reservadas</h1>
        <table id="tablaHabitaciones">
            ...
            $reservadas = $reservaDAO->obtener_reservas_sin_checkin();
