...
<div class="sidebar">
        ...
        <form action="registrarCheckOUT.php" method="POST">
            <input type="submit" value="Cerrar Sesión" formnovalidate>
        </form>
    </div>
    <div class="content">
        <h1><a class="back-link" href="habitaciones.php">&lt;Volver</a> Check Out</h1>
        <form class="formRegistro">
            ...
            <?php 
                ...
                $reservas = $reservasDAO->obtenerReservasConCheckIn();
            ...
            <input class="registroSumbit" type="submit" value="Check Out">
        </form>
    </div>
</body>
